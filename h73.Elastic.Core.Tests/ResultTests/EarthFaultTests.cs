...
namespace h73.Elastic.Core.Tests.ResultTests
{
    ...
    public class EarthFaultTests
    {
        ...
        public void Result_with_filtered_aggregation()
        {
            ...
            var resultObject = JsonConvert.DeserializeObject<SearchResult<Event>>(result, js);
        } 
        ...
        public void Result_nested_aggs_with_tophits()
        {
            ...
            var js = JsonHelpers.CreateSerializerSettings();
            var resultObject = JsonConvert.DeserializeObject<SearchResult<EarthFaultEvent>>(result, js);
